...
public class UpdateFeedbackController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        Feedback fb = feed.getFeedbackByCreatedBy(u.getId());
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Feedback fb = dao.getFeedbackByCreatedBy(u.getId());
        boolean add = dao.updateFeedback(star, comment, fb.getId());
        if(add){
            response.sendRedirect("updatefeedback?id="+u.getId());
        }else{
